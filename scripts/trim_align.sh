...
time /usr/local/htseq/0.6.1p1/bin/htseq-count -f bam -s no -t exon -i gene_id -m union tophat/accepted_hits.bam ../ref/transcriptome/Boleracea_v2.1.31.gff > gene_counts.tsv
